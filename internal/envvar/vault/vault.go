...
var (
	ErrMissingVaultKeyValue = errors.New("missing key value")
	ErrVaultSecretNotFound  = errors.New("secret not found")
...
func (p *Provider) Get(v string) (string, error) {
	...
	if len(split) == 1 {
		return "", ErrMissingVaultKeyValue
	}
