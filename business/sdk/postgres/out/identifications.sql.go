...
const CreateIdentification = `-- name: CreateIdentification :one
...
func (q *Queries) CreateIdentification(ctx context.Context, arg CreateIdentificationParams) (Identifications, error) {
	row := q.db.QueryRow(ctx, CreateIdentification,
		arg.ID,
		arg.FirstName,
		arg.LastName,
		arg.MiddleName,
